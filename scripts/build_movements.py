...
# Biomechanical/modality movement pattern(s), independent of the equipment-based
# `category` above. A movement can hit more than one pattern:
#   - Compound lifts decompose by what actually happens in the rep: any barbell/
#     dumbbell/kettlebell/odd-object clean or snatch that pulls FROM THE FLOOR
#     gets `hinge` (that first pull is a deadlift); a full-depth squat catch adds
#     `squat`, a partial/power/muscle catch adds `pull` instead, and a split-stance
#     catch adds `lunge`. A jerk/press finish (…-and-jerk, ground-to-overhead) adds
#     `push`; a snatch's continuous pull-under never does (no separate press phase).
#     "Hang" variants skip `hinge` — the whole point is removing the floor pull.
#   - `olympic` and `monostructural` are modality tags, not pure biomechanics
#     (matches how programming tools group the barbell classics / cardio
#     machines as their own bucket); `gymnastics` is the third CrossFit modality,
#     added the same way — additively, on top of whatever biomechanical tags a
#     movement already carries. Deliberately narrower than category:"gymnastics"
#     (62 movements): only genuine skill work (rings/bars/handstand/climbing/
#     pistols) gets it, not core/hinge accessory work that just happens to need
#     no equipment (sit-ups, planks, back extensions stay core/hinge-only).
#   - A double-leg explosive jump (box jump, broad jump, tuck jump) never reaches
#     real squat or lunge depth — tagged with no biomechanical pattern rather than
#     force-fit into one, same call wod-wiz's own (now-superseded) heuristic made.
#   - A burpee's chest-to-floor rep is a genuine full-ROM push-up, so every burpee
#     variant gets `push` in addition to `core`.
# This is our own functional classification, not copied from any glossary. Every
# slug in GROUPS must have an entry here (checked below).
PATTERNS = {
    # barbell
    ...
    "clean": ["olympic", "hinge", "squat"], "power-clean": ["olympic", "hinge", "pull"],
    "squat-clean": ["olympic", "hinge", "squat"],
    "hang-clean": ["olympic", "squat"], "hang-power-clean": ["olympic", "pull"],
    "ground-to-overhead": ["olympic", "hinge", "pull", "push"],
    "hang-squat-clean": ["olympic", "squat"],
    "muscle-clean": ["olympic", "hinge", "pull"], "clean-pull": ["olympic", "hinge", "pull"],
    "clean-and-jerk": ["olympic", "hinge", "squat", "push"],
    "bodyweight-clean-and-jerk": ["olympic", "hinge", "squat", "push"],
    "snatch": ["olympic", "hinge", "squat"], "power-snatch": ["olympic", "hinge", "pull"],
    "squat-snatch": ["olympic", "hinge", "squat"],
    "hang-snatch": ["olympic", "squat"], "hang-power-snatch": ["olympic", "pull"],
    "muscle-snatch": ["olympic", "hinge", "pull", "push"],
    "snatch-pull": ["olympic", "hinge", "pull"],
    "snatch-balance": ["olympic", "squat"],
    ...
    "bent-over-row": ["pull", "hinge"], "pendlay-row": ["pull", "hinge"],
    "overhead-walk": ["carry"],
    # dumbbell
    "dumbbell-thruster": ["squat", "push"], "single-arm-dumbbell-thruster": ["squat", "push"],
    "dumbbell-snatch": ["olympic", "hinge", "pull"],
    "dumbbell-power-snatch": ["olympic", "hinge", "pull"],
    "alternating-dumbbell-snatch": ["olympic", "hinge", "pull"],
    "alternating-dumbbell-power-snatch": ["olympic", "hinge", "pull"],
    "dumbbell-clean": ["olympic", "hinge", "pull"],
    "dumbbell-power-clean": ["olympic", "hinge", "pull"],
    "dumbbell-squat-clean": ["olympic", "hinge", "squat"],
    "dumbbell-hang-squat-clean": ["olympic", "squat"],
    "dumbbell-split-clean": ["olympic", "hinge", "lunge"],
    "dumbbell-hang-split-snatch": ["olympic", "lunge"],
    "dumbbell-clean-and-jerk": ["olympic", "hinge", "pull", "push"],
    "dumbbell-squat-clean-thruster": ["olympic", "hinge", "squat", "push"],
    "dumbbell-hang-clean-to-overhead": ["olympic", "pull", "push"],
    "dumbbell-hang-clean-and-jerk": ["olympic", "pull", "push"],
    ...
    "dumbbell-shoulder-to-overhead": ["push"],
    "dumbbell-hang-power-clean": ["olympic", "pull"],
    ...
    "dumbbell-burpee-deadlift": ["hinge", "core", "push"],
    ...
    "devils-press": ["olympic", "core", "hinge", "pull"],
    ...
    "kettlebell-clean": ["olympic", "hinge", "pull"],
    "kettlebell-clean-and-jerk": ["olympic", "hinge", "pull", "push"],
    "kettlebell-snatch": ["olympic", "hinge", "pull"],
    ...
    "turkish-get-up": ["core"], "kettlebell-windmill": ["core", "hinge"],
    "kettlebell-halo": ["core"],
    ...
    # gymnastics
    "pull-up": ["pull", "gymnastics"], "kipping-pull-up": ["pull", "gymnastics"],
    "butterfly-pull-up": ["pull", "gymnastics"], "strict-pull-up": ["pull", "gymnastics"],
    "chest-to-bar-pull-up": ["pull", "gymnastics"], "l-pull-up": ["pull", "core", "gymnastics"],
    "weighted-pull-up": ["pull", "gymnastics"], "burpee-pull-up": ["core", "pull", "push", "gymnastics"],
    "jumping-pull-up": ["pull", "gymnastics"],
    "chin-up": ["pull", "gymnastics"], "negative-pull-up": ["pull", "gymnastics"],
    "muscle-up": ["pull", "push", "gymnastics"], "bar-muscle-up": ["pull", "push", "gymnastics"],
    "ring-muscle-up": ["pull", "push", "gymnastics"], "strict-muscle-up": ["pull", "push", "gymnastics"],
    "burpee-muscle-up": ["core", "pull", "push", "gymnastics"],
    "burpee-bar-muscle-up": ["core", "pull", "push", "gymnastics"],
    "handstand-push-up": ["push", "gymnastics"], "strict-handstand-push-up": ["push", "gymnastics"],
    "kipping-handstand-push-up": ["push", "gymnastics"],
    "deficit-handstand-push-up": ["push", "gymnastics"],
    "freestanding-handstand-push-up": ["push", "gymnastics"],
    "wall-facing-handstand-push-up": ["push", "gymnastics"],
    "ring-handstand-push-up": ["push", "gymnastics"],
    "parallette-handstand-push-up": ["push", "gymnastics"],
    "handstand": ["core", "gymnastics"], "handstand-hold": ["core", "gymnastics"],
    "handstand-walk": ["push", "carry", "gymnastics"],
    "wall-climb": ["push", "gymnastics"], "wall-climb-over": ["push", "gymnastics"],
    "ring-dip": ["push", "gymnastics"], "bar-dip": ["push", "gymnastics"],
    "strict-dip": ["push", "gymnastics"],
    "ring-row": ["pull", "gymnastics"], "ring-push-up": ["push", "gymnastics"], "push-up": ["push"],
    "hand-release-push-up": ["push"],
    "toes-to-bar": ["core", "gymnastics"], "toes-to-ring": ["core", "gymnastics"],
    "knees-to-elbows": ["core", "gymnastics"],
    "hanging-knee-raise": ["core"], "hanging-hip-touch": ["core"],
    "rope-climb": ["pull", "gymnastics"], "legless-rope-climb": ["pull", "gymnastics"],
    "pegboard": ["pull", "gymnastics"],
    "pistol": ["squat", "gymnastics"], "forward-roll": ["core", "gymnastics"],
    "ring-lower": ["pull", "gymnastics"],
    "pull-over": ["pull", "gymnastics"], "parallel-bar-traverse": ["pull", "gymnastics"],
    "obstacle-pirouette": ["core", "gymnastics"],
    "sit-up": ["core"], "ghd-sit-up": ["core"], "ab-mat-sit-up": ["core"], "v-up": ["core"],
    "hollow-rock": ["core"], "hollow-hold": ["core"], "l-sit": ["core", "gymnastics"],
    "plank": ["core"],
    ...
    "burpee": ["core", "push"], "bar-facing-burpee": ["core", "push"],
    "burpee-over-the-bar": ["core", "push"],
    "lateral-burpee": ["core", "push"],
    "burpee-box-jump": ["core", "push"], "burpee-box-jump-over": ["core", "push"],
    "burpee-broad-jump": ["core", "push"], "burpee-over-dumbbell": ["core", "push"],
    "box-jump": [], "box-jump-over": [], "box-step-up": ["lunge"],
    ...
    # odd-object
    "wall-ball-shot": ["squat", "push"], "medicine-ball-clean": ["olympic", "hinge", "pull"],
    "medicine-ball-sit-up": ["core"], "medicine-ball-box-step-over": ["lunge"],
    "ball-slam": ["core"],
    "sandbag-carry": ["carry"], "sandbag-clean": ["olympic", "hinge", "pull"],
    "sandbag-ground-to-shoulder": ["olympic", "hinge", "pull"], "sandbag-squat": ["squat"],
    ...
    "atlas-stone-over-shoulder": ["hinge"], "d-ball-clean": ["olympic", "hinge", "pull"],
    "d-ball-over-shoulder": ["hinge"], "tire-flip": ["hinge"],
    "log-clean-and-jerk": ["olympic", "hinge", "pull", "push"], "log-press": ["push"],
    "plate-ground-to-overhead": ["olympic", "hinge", "pull", "push"], "plate-carry": ["carry"],
}
